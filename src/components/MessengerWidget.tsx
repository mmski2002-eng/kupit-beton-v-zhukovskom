import { telegram, whatsapp } from '@/data/site';
import styles from './MessengerWidget.module.css';

export function MessengerWidget() {
  return (
    <div className={styles.widget}>
      <a className={`${styles.btn} ${styles.wa}`} href={whatsapp.href} aria-label="Написать в WhatsApp">
      ...
      <a
        ...
        href={telegram.appHref}
        data-fallback-href={telegram.webHref}
        aria-label="Написать в Telegram"
      >
        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          <path d="M21.8 4.3 18.5 20c-.2 1.1-.9 1.4-1.8.9l-5-3.7-2.4 2.3c-.3.3-.5.5-1 .5l.4-5.1 9.3-8.4c.4-.4-.1-.6-.6-.2L5.8 13.5.9 12c-1.1-.3-1.1-1.1.2-1.6L20.3 3c.9-.3 1.7.2 1.5 1.3z" />
        </svg>
      </a>
    </div>
  );
